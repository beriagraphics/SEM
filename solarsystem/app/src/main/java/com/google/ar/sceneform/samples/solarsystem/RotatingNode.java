...
/** Node for rotation and transformations */
public class RotatingNode extends Node {
  ...
  private static ObjectAnimator createAnimator(boolean clockwise, float axisTiltDeg) {
    // These calculations have been acquired from online sources
    ...
    // QuaternionEvaluator (by Sceneform)
    orbitAnimation.setEvaluator(new QuaternionEvaluator());

    //  repeat orbitAnimation forever
